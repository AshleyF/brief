...
test "Sequence" [Nil; Int 123I; Bool true; Int 200I; Array [Nil; Int 123I; Bool true]; Bool false; String "foo"; Int 123I; String "the quick brown fox jumps over the"; Int 42I]
